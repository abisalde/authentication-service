...
import (
	...
	"github.com/abisalde/authentication-service/internal/database/ent/migrate"
...
func (c *UserClient) QueryAddress(u *User) *UserAddressQuery {
...
type (
	hooks struct {
		User, UserAddress []ent.Hook
	}
	inters struct {
		User, UserAddress []ent.Interceptor
	}
)
